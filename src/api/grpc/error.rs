...
impl From<crate::api::rest::ApiError> for tonic::Status
{
    fn from(err: crate::api::rest::ApiError) -> Self
    {
        ...
        match err
        {
            ...
            crate::api::rest::ApiError::Unauthorized => tonic::Status::unauthenticated("未登录"),
            crate::api::rest::ApiError::NotFound(msg) => tonic::Status::not_found(msg),
            crate::api::rest::ApiError::Validation(msg) => tonic::Status::invalid_argument(msg),
            crate::api::rest::ApiError::Forbidden(msg) => tonic::Status::permission_denied(msg),
            crate::api::rest::ApiError::Other(msg) => tonic::Status::internal(msg),
        }
    }
}
